...
PLATFORM_API="https://$(oc get route -n ${NAMESPACE} small-mgmt-platform-api -o jsonpath="{.spec.host}")/"
CERTIFICATE="$(oc get route -n ${NAMESPACE} small-mgmt-platform-api -o json | jq -r .spec.tls.caCertificate)"
